import{fM as Ie,li as ae,es as Ue,gu as $e,B as q,lj as ke,lk as Le,ll as Ne,ia as He,lm as qe,ln as Ge,ev as x,af as Ve,bm as Pe,q as Ce,eH as We,bu as K,eu as Z,eN as Y,k6 as je,eA as oe,eB as Ke,ey as Ye,jw as Xe,jy as Qe,eD as le,hi as Je,jT as Ze,lo as et,lp as tt,Q as it,jV as de,lq as rt,_ as ue,jW as st,u as nt,ep as at,k as X,P as ot,ak as he,cn as lt,lr as dt,U as ce}from"./index-_dU_iSbC.js";import{c as ut}from"./ExpandedCIM-EqtATKhk.js";import{p as ht,s as ct}from"./imageUtils-hjhOHoR2.js";import{t as _t,b as ft,o as _e,h as mt,i as pt}from"./Container-_QA7nuyl.js";import{i as gt}from"./BufferPool-GfU65DXC.js";import{T as B,E as S,S as $}from"./color-MoG5E2oX.js";import{g as vt,a as L,h as G,w as A,d as bt,m as xt}from"./WGLContainer-3x8Q4cnm.js";import{L as E}from"./enums-W_WZ2jKy.js";import{e as wt,a as W,f as ee}from"./ProgramTemplate-Ltda-mNV.js";import{n as U}from"./programUtils-m7uWDKUk.js";import{e as fe,r as yt,t as Tt,a as Ft,m as Bt,J as Et,n as Ot,b as Rt,c as Mt}from"./MagnifierPrograms-r_qeWXXS.js";import{d as is,y as rs}from"./MagnifierPrograms-r_qeWXXS.js";import{h as te,E as C,a as ie,i as Pt}from"./FramebufferObject-RCeL4O_T.js";import{R as v,E as H,F as re,O as j,I as Q,L as D,C as me,D as O,B as se,G as T,U as ne,P as Ct}from"./enums-8pc8f5Ge.js";import{o as pe,N as St}from"./RenderingContext-9aJHMps6.js";import{z as At,q as Dt,Q as zt,E as It,F as Ut,L as N,M as $t,_ as Se,R as ge}from"./definitions-9tXFrCdu.js";import{t as ve}from"./VertexElementDescriptor-0hGjloLE.js";import{e as R,T as k}from"./Texture-qs2mP2n9.js";import{r as ns}from"./GraphicsView2D-dVCNvSxW.js";import{i as os}from"./GraphicContainer-3Vzq-s5K.js";import{t as be}from"./requestImageUtils-z9sx1bIU.js";import"./BidiEngine-8z8MVveq.js";import"./visualVariablesUtils-L5SycTO1.js";import"./OptimizedGeometry-1RFAES06.js";import"./GeometryUtils-CEMOhUyj.js";import"./enums--FbEXJ87.js";import"./utils-WSVhIa5b.js";import"./GeometryUtils-D_QpbI_S.js";import"./Rect-pT1ASav_.js";import"./quantizationUtils-adEHf9y5.js";import"./floatRGBA-wSML2Jow.js";import"./AttributeStoreView-8FlCXQIn.js";import"./TiledDisplayObject-MhfQaoyZ.js";import"./util-pvwubzOV.js";import"./StyleDefinition-ohiNeWtS.js";import"./config-z2KFXUcx.js";import"./earcut-x1fbMz4s.js";import"./featureConversionUtils-YwOEkXDp.js";import"./OptimizedFeatureSet-smVI1ez9.js";import"./NestedMap-9UouPomH.js";import"./rasterizingUtils-WU1b0uDl.js";import"./pbf-VcPVuOP3.js";import"./imageutils-UMC0OnPa.js";import"./Matcher-qLucttOY.js";import"./tileUtils-pcBJnprf.js";import"./TurboLine-tb6RCzsH.js";import"./CircularArray-1_thnT0U.js";import"./testSVGPremultipliedAlpha-v1e9yagD.js";import"./throttle-SZpAiZ7F.js";import"./ComputedAttributeStorage-B-ne3mtc.js";import"./TimeOnly-GUFt9a4u.js";import"./OrderIndependentTransparency-JGZ_PxZN.js";import"./basicInterfaces-IwaMq8O_.js";import"./doublePrecisionUtils-HJiLm-yC.js";import"./normalizeUtilsSync-seZmd-S0.js";import"./projectionSupport-PDoH8Bht.js";import"./json-v6EOeNTY.js";import"./BaseGraphicContainer-_iMAsAtD.js";import"./FeatureContainer-cjuXK2sS.js";import"./TileContainer-rnhPnJ5A.js";import"./vec3f32-6rWBPTzX.js";let kt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=ht(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}loadFont(e){return ut(e)}},Lt=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),h=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[h,_]),f}};const Nt={background:{"background.frag":`#ifdef PATTERN
