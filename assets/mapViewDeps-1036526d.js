import{eL as Ie,jI as ae,el as Ue,fJ as $e,x as q,jJ as ke,jK as Le,jL as Ne,hg as He,jM as qe,jN as Ge,en as x,a4 as Ve,bd as Pe,o as Ce,ex as We,cf as K,em as Z,eZ as Y,iY as je,es as oe,et as Ke,eq as Ye,iv as Xe,ix as Qe,aC as le,gx as Je,iO as Ze,jO as et,jP as tt,I as it,iQ as de,jQ as rt,_ as ue,iR as st,u as nt,ei as at,k as X,P as ot,ay as he,cA as lt,jR as dt,H as ce}from"./index-501d5c3e.js";import{c as ut}from"./ExpandedCIM-ccb97729.js";import{p as ht,s as ct}from"./imageUtils-4e04d229.js";import{t as _t,b as ft,o as _e,h as mt,i as pt}from"./Container-33a9bac0.js";import{i as gt}from"./BufferPool-d6fbbc81.js";import{T as B,E as S,S as $}from"./color-9bfc82b7.js";import{g as vt,a as L,h as G,w as A,d as bt,m as xt}from"./WGLContainer-b9f2807c.js";import{L as E}from"./enums-fb086c25.js";import{e as wt,a as W,f as ee}from"./ProgramTemplate-f02ea953.js";import{n as U}from"./programUtils-5bca9858.js";import{e as fe,r as yt,t as Tt,a as Ft,m as Bt,J as Et,n as Ot,b as Rt,c as Mt}from"./MagnifierPrograms-9e9a0e79.js";import{d as bs,y as xs}from"./MagnifierPrograms-9e9a0e79.js";import{h as te,E as C,a as ie,i as Pt}from"./FramebufferObject-27a2ddd2.js";import{R as v,E as H,F as re,O as j,I as Q,L as D,C as me,D as O,B as se,G as T,U as ne,P as Ct}from"./enums-bdecffa2.js";import{o as pe,N as St}from"./RenderingContext-55529823.js";import{z as At,q as Dt,Q as zt,E as It,F as Ut,L as N,M as $t,_ as Se,R as ge}from"./definitions-f0076f57.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-43ccce05.js";import{r as ys}from"./GraphicsView2D-555ba952.js";import{i as Fs}from"./GraphicContainer-87cdf632.js";import{t as be}from"./requestImageUtils-7be45db5.js";import"./BidiEngine-9a40f2f4.js";import"./visualVariablesUtils-86628082.js";import"./OptimizedGeometry-d94e541f.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./utils-7f51b05b.js";import"./GeometryUtils-34ea995c.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-4e11664e.js";import"./floatRGBA-133fb535.js";import"./parser-8671e071.js";import"./AttributeStoreView-c75dc9e3.js";import"./TiledDisplayObject-dc0e71bc.js";import"./diffUtils-6e5fab09.js";import"./labelingInfo-47db59fe.js";import"./LabelClass-500f5c90.js";import"./labelUtils-fd986b3d.js";import"./defaultsJSON-b087dd4d.js";import"./jsonUtils-b605ba6a.js";import"./clusterUtils-c61bc31d.js";import"./MD5-715f37cd.js";import"./SizeVariable-5a9f1675.js";import"./colorRamps-4dfd6985.js";import"./LegendOptions-174460fb.js";import"./lengthUtils-4a55512d.js";import"./util-236c2a82.js";import"./heatmapUtils-dbd26df3.js";import"./vec4f64-3c9d0901.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-b54ac523.js";import"./featureConversionUtils-b92e0da2.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./rasterizingUtils-20c7dc07.js";import"./pbf-5754defe.js";import"./imageutils-4891ac9c.js";import"./Matcher-94fcb576.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-0d0d63b1.js";import"./LRUCache-7ac1a9e7.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-1b0629da.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-8b4048e5.js";import"./FieldsIndex-728afcfb.js";import"./TimeOnly-cedc495a.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-7b09c7b0.js";import"./projectionSupport-55b02e86.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-880d1d2f.js";import"./FeatureContainer-563721b0.js";import"./TileContainer-b5a21260.js";import"./vec3f32-2da9db36.js";let kt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=ht(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}loadFont(e){return ut(e)}},Lt=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),h=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[h,_]),f}};const Nt={background:{"background.frag":`#ifdef PATTERN
