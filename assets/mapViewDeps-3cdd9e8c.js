import{fM as Ie,lf as ae,es as Ue,gu as $e,B as q,lg as ke,lh as Le,li as Ne,ia as He,lj as qe,lk as Ge,ev as x,af as Ve,bn as Pe,q as Ce,eH as We,bv as K,eu as Z,eN as Y,k4 as je,eA as oe,eB as Ke,ey as Ye,ju as Xe,jw as Qe,eD as le,hi as Je,jR as Ze,ll as et,lm as tt,Q as it,jT as de,ln as rt,_ as ue,jU as st,u as nt,ep as at,k as X,P as ot,ak as he,cl as lt,lo as dt,U as ce}from"./index-e4bd4bbf.js";import{c as ut}from"./ExpandedCIM-d6ae120e.js";import{p as ht,s as ct}from"./imageUtils-cab33836.js";import{t as _t,b as ft,o as _e,h as mt,i as pt}from"./Container-77470976.js";import{i as gt}from"./BufferPool-bf8dd66d.js";import{T as B,E as S,S as $}from"./color-842d1d33.js";import{g as vt,a as L,h as G,w as A,d as bt,m as xt}from"./WGLContainer-4dc5cc0d.js";import{L as E}from"./enums-fb086c25.js";import{e as wt,a as W,f as ee}from"./ProgramTemplate-0843fa08.js";import{n as U}from"./programUtils-f20ca56a.js";import{e as fe,r as yt,t as Tt,a as Ft,m as Bt,J as Et,n as Ot,b as Rt,c as Mt}from"./MagnifierPrograms-8863c997.js";import{d as is,y as rs}from"./MagnifierPrograms-8863c997.js";import{h as te,E as C,a as ie,i as Pt}from"./FramebufferObject-d5148c25.js";import{R as v,E as H,F as re,O as j,I as Q,L as D,C as me,D as O,B as se,G as T,U as ne,P as Ct}from"./enums-bdecffa2.js";import{o as pe,N as St}from"./RenderingContext-30d21426.js";import{z as At,q as Dt,Q as zt,E as It,F as Ut,L as N,M as $t,_ as Se,R as ge}from"./definitions-a222d0c4.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-3333b9d9.js";import{r as ns}from"./GraphicsView2D-83f26baf.js";import{i as os}from"./GraphicContainer-a9d761ad.js";import{t as be}from"./requestImageUtils-60231858.js";import"./BidiEngine-9a40f2f4.js";import"./visualVariablesUtils-a60b7147.js";import"./OptimizedGeometry-d94e541f.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./utils-0e593a8d.js";import"./GeometryUtils-a7b4674c.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-dc2930b9.js";import"./floatRGBA-672489f4.js";import"./AttributeStoreView-8798d805.js";import"./TiledDisplayObject-a7718bb6.js";import"./util-63b5e103.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-a7a6c3b0.js";import"./featureConversionUtils-6f0b0b93.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./rasterizingUtils-4bc83685.js";import"./pbf-a78b4b36.js";import"./imageutils-994a7f0e.js";import"./Matcher-152ab9e9.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-8ab88281.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-56236592.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-cb9abf58.js";import"./TimeOnly-d90019a5.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-e2bc71ee.js";import"./projectionSupport-3e518cee.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-7314ec55.js";import"./FeatureContainer-a3ab1903.js";import"./TileContainer-6ec69209.js";import"./vec3f32-2da9db36.js";let kt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=ht(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}loadFont(e){return ut(e)}},Lt=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),h=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[h,_]),f}};const Nt={background:{"background.frag":`#ifdef PATTERN
